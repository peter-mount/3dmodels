...
pcb_front_lug_inner_radius = pcb_back_lug_inner_radius;
...
module pcb_back_plug(x, y) {
    translate([x, back_depth, y])
        rotate([90, 0, 0])
            difference() {
...
//
module BBCCartridge(component = 3, backStyle = 1, topLabelInset = 0) {
